...
- **Global scope**: `/home/gabriel/Documents/gabriel-rodrigues/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/gabriel/Documents/gabriel-rodrigues/.claude/notes/`)
...
2. Glob `/home/gabriel/Documents/gabriel-rodrigues/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/gabriel/Documents/gabriel-rodrigues/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/gabriel/Documents/gabriel-rodrigues/.claude/notes/` — works in any directory
